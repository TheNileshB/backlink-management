...
<div style="width: 95%; margin-bottom: 80px; margin-top: 8px;">
	...
	<div style="background: ; width: 100%; margin-bottom: 10px; overflow: hidden;">
        ...
        <a href="profile-backlink.php">
          <button style="margin-right: 20px;" class="btn btn-success">Profile
            <span style="color:black; margin-left:5px; font-size:14px;">(<?php echo $total_Profile_backlink; ?>)</span>
          </button>
        </a>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
  ...
  $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `webinformer_backlink` WHERE backlink_category='Profile' AND active_status='' ");
  ...
  ////////////////////////////[Pagination Code End]/////////////////////////////////////
  		...
  		$no=0;
        $query1 = "SELECT  * FROM  webinformer_backlink WHERE backlink_category='Profile' AND active_status='' order by 1 DESC LIMIT $offset, $total_records_per_page ";
        $query2 = mysqli_query($conn, $query1);
