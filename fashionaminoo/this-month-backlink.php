...
include_once('db-connect.php');
    ...
    $conn = new mysqli($servername, $username, $password, $dbname);
        ...
        /////////////////////// [This Month Backlink Count Code] ///////////////////////
            ...
            $this_month_date_m  =  date("m");
            $this_month_date_y  =  date("Y");
            
            $month = $this_month_date_m-1;
            $this_month = $month+1;

            $this_month_date = $this_month."/".$this_month_date_y;
...
<html>
<head>
	<title>This Month Backlink</title>
...
<div style="width: 95%; margin-bottom: 80px; margin-top: 8px;">
    ...
    <h1 style="font-weight: bold; color: #FF8300; font-size: 45px;">This Month Backlink 
      <span style="color:black; margin-left:5px; font-size:16px;">(<?php echo $this_month_backlink; ?>)</span>
    </h1>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
  ...
  $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `webinformer_backlink` WHERE create_date like '%$this_month_date%' AND active_status='' ");
  ...
  ////////////////////////////[Pagination Code End]/////////////////////////////////////
  		...
  		$no=0;
        $query1 = "SELECT * FROM webinformer_backlink WHERE create_date like '%$this_month_date%' AND active_status=''  order by 1 DESC LIMIT $offset, $total_records_per_page ";
