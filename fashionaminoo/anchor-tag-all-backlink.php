...
{
  header('location:http://localhost/backlink-management/all-anchor-tag.php');
}
...
<html>
<head>
	<title>Backlink By Anchor Tag</title>
...
<div style="width: 95%; margin-bottom: 80px; margin-top: 8px;">
    ...
    <h1 style="font-weight: bold; color: black; font-size: 45px;">Backlink By Anchor Tags</h1>
    <br>
    <br>
    ...
    <form action="" method="get">
		<div class="row">
      <div class="col-xl-1 col-lg-1" style="text-align: left;">
        <a href="http://localhost/backlink-management/all-anchor-tag.php">
          <button type="button" class="btn btn-danger">Back</button>
        </a>
      </div>

			<div class="col-xl-9 col-lg-9" style="text-align: left; margin-left: 10px;">
          <span style="font-weight: bold; color: black; font-size: 19px; margin-right: 15px;">
            Anchor :
          </span>
          <span style="font-weight: bold; font-size: 19px;">
            <?php echo $search_anchor; ?>
          </span>
      </div>
		</div>
    </form>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
  ...
  $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `webinformer_backlink` WHERE anchor LIKE '%$search_anchor%' AND active_status='' ");
  ...
  ////////////////////////////[Pagination Code End]/////////////////////////////////////
      ...
      $no=0;
        $query1 = "SELECT  * FROM  webinformer_backlink WHERE anchor LIKE '%$search_anchor%' AND active_status='' order by 1 DESC LIMIT $offset, $total_records_per_page";
