...
<html>
<head>
	<title>Guest Post Backlink</title>
...
<div style="width: 95%; margin-bottom: 80px; margin-top: 8px;">
	...
	<div style="background: ; width: 100%; margin-bottom: 10px; overflow: hidden;">
		<div class="row">
			...
			<div class="col-xl-10 col-lg-10" style="text-align: left; margin: 0; padding: 0;">
				<a href="total-backlink.php">
          <button style="margin-right: 20px; background: #AAB7B8;" class="btn">All Backlink</button>    
        </a>
        ...
        <a href="commenting-backlink.php">
          <button style="margin-right: 20px; background: #AAB7B8;" class="btn">Commenting
        ...
        <a href="guest-post-backlink.php">
          <button style="margin-right: 20px;" class="btn btn-success">Guest Post
           <span style="color:black; margin-left:5px; font-size:14px;">(<?php echo $total_Guest_Post_backlink; ?>)</span>
          </button>
        </a>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
  ...
  $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `webinformer_backlink` WHERE backlink_category='Guest Post' AND active_status='' ");
  ...
  ////////////////////////////[Pagination Code End]/////////////////////////////////////
  		...
  		$no=0;
        $query1 = "SELECT  * FROM  webinformer_backlink WHERE backlink_category='Guest Post' AND active_status='' order by 1 DESC LIMIT $offset, $total_records_per_page ";
        $query2 = mysqli_query($conn, $query1);
