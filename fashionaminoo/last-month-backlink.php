...
<html>
<head>
	<title>Last Month Backlink</title>
...
<div style="width: 95%; margin-bottom: 80px; margin-top: 8px;">
    ...
    <h1 style="font-weight: bold; color: #FF8300; font-size: 45px;">Last Month Backlink 
      <span style="color:black; margin-left:5px; font-size:16px;">(<?php echo $last_month_backlink; ?>)</span>
    </h1>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
  ...
  $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `webinformer_backlink` WHERE create_date like '%$last_month_date%' AND active_status='' ");
  ...
  ////////////////////////////[Pagination Code End]/////////////////////////////////////
        ...
        $query1 = "SELECT * FROM webinformer_backlink WHERE create_date like '%$last_month_date%' AND active_status='' order by 1 DESC  LIMIT $offset, $total_records_per_page ";
    ...
    <tr>
      ...
      <th>
        ...
        $query1 = "SELECT * FROM webinformer_backlink WHERE backlink='$backlink' AND active_status='' ";
